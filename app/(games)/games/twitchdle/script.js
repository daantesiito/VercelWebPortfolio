...
document.addEventListener('DOMContentLoaded', () => {
            ...
            const emoteSources = [
                ...
                './media/7tv/32.gif',
                './media/7tv/44.gif',
                './media/7tv/BASEDCIGAR.gif',
                './media/7tv/catJam.gif',
                './media/7tv/Nerd.gif',
                './media/7tv/happi.gif',
                './media/7tv/JIJO.gif',
                './media/7tv/nowaying.gif',
                './media/7tv/omegalul.gif',
                './media/7tv/Nerdd.png',
                './media/7tv/sadcat.gif',
                './media/7tv/Sadge.gif',
                './media/7tv/nerd.png',
                './media/7tv/Nerdge.gif',
                './media/7tv/sigma.gif',
                './media/7tv/sigmaArrive.gif',
                './media/7tv/yipe.gif',
                './media/7tv/yump.gif'
            ];
